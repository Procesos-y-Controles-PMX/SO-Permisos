...
export const SECTION_PANEL =
  `overflow-hidden rounded-sm border border-line bg-card ${PANEL_SHADOW}`

export const SECTION_PANEL_HEADER =
  'flex items-center justify-between border-b border-line-subtle px-5 py-4 sm:px-6 sm:py-5'
